...
export const Dashboard = () => {
  ...
  const [equipmentsUnderMaintenance, setEquipmentsUnderMaintenance] = useState(0);
    ...
    onValue(equipementsRef, (snapshot) => {
      ...
      if (equipementsData) {
        ...
        equipementsArray.forEach((equipment) => {
          ...
          if (equipment.MaintenanceCost) maintenanceCost += equipment.MaintenanceCost;
  ...
  return (
    <Box p={4} mx="auto" bg={useColorModeValue('white', 'gray.700')} borderWidth={1} borderRadius="md" boxShadow="md">
